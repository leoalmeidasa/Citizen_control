...
class CitizensControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create citizen' do
    assert_difference('Citizen.count') do
      post citizens_url,
           params: { citizen: { birth_date: @citizen.birth_date, cns: @citizen.cns, cpf: @citizen.cpf, email: @citizen.email,
                                name: @citizen.name, status: @citizen.status, telephone: @citizen.telephone } }
    end
